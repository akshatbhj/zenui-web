  ...
  return (
    <div className="overflow-x-auto">
      <table className="min-w-full bg-gray-800 rounded-lg shadow-md overflow-hidden">
        <thead>
          <tr className="text-left border-b border-gray-600 bg-gray-700 text-gray-300">
        ...
        <tbody className="text-gray-300">
          <tr className="hover:bg-gray-700 transition-colors duration-200">
            ...
            <td className="py-4 px-6 border-b border-gray-600">Software Engineer</td>
            <td className="py-4 px-6 border-b border-gray-600">San Francisco</td>
          ...
          <tr className="hover:bg-gray-700 transition-colors duration-200">
            ...
            <td className="py-4 px-6 border-b border-gray-600">Product Manager</td>
          ...
          <tr className="hover:bg-gray-700 transition-colors duration-200">
            <td className="py-4 px-6 border-b border-gray-600">Alice Johnson</td>
            <td className="py-4 px-6 border-b border-gray-600">UI/UX Designer</td>
          ...
          <tr className="hover:bg-gray-700 transition-colors duration-200">
            <td className="py-4 px-6 border-b border-gray-600">Michael Brown</td>
            <td className="py-4 px-6 border-b border-gray-600">DevOps Engineer</td>
